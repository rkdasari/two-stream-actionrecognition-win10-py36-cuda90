...
class spatial_dataset(Dataset):  
    ...
    def load_ucf_image(self,video_name, index):
        if video_name.split('_')[0] == 'HandstandPushups':
            ...
            name = g
            path = self.root_dir +'v_'+ 'HandstandPushups_'+ name +'\\frame'
        else:
...
class spatial_dataloader():
    ...
    def load_frame_count(self):
        ...
        with open('D:\\Radha\\Downloads\\two-stream-action-recognition-master\\dataloader\\dic\\frame_count.pickle','rb') as file:
