...
parser.add_argument('--batch-size', default=6, type=int, metavar='N', help='mini-batch size (default: 64)')
...
def main():
    ...
    data_loader = dataloader.Motion_DataLoader(
                        ...
                        num_workers=0,
                        path='D:\\Data\\UCF101\\ucf101_tvl1_flow\\tvl1_flow\\',
                        ucf_list='D:\\Radha\\Downloads\\two-stream-action-recognition-master\\UCF_list\\',
                        ucf_split='01',
                        in_channel=10,
                        )
...
class Motion_CNN():
    ...
    def train_1epoch(self):
        ...
        info = {'Epoch':[self.epoch],
                ...
                'Loss':[round(int(losses.avg),5)],
                'Prec@1':[round(int(top1.avg),4)],
                'Prec@5':[round(int(top5.avg),4)],
    ...
    def validate_1epoch(self):
        ...
        info = {'Epoch':[self.epoch],
                'Batch Time':[round(batch_time.avg,3)],
                'Loss':[round(int(video_loss),5)],
                'Prec@1':[round(int(video_top1),3)],
                'Prec@5':[round(int(video_top5),3)]
                }
